"""
Run this once to create a Desktop shortcut for Dev Buddy.
...
SHORTCUT = os.path.join(DESKTOP, "Dev Buddy.lnk")
...
$shortcut.Description      = "Dev Buddy"
$shortcut.Save()
"""
...
print("  1. Find 'Dev Buddy' on your Desktop")
